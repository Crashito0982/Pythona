...
# ----------------------------------------------------------------------
# En producción, la ruta base es el share de red de BRITIMP.
# Para pruebas locales, podés sobrescribirla con la variable de entorno
# BRITIMP_ROOT, por ejemplo:
#
#   export BRITIMP_ROOT="/home/leonardd/Plexus/BRITIMP"
#
...
# ----------------------------------------------------------------------
#  EC ATM (EFECTIVO ATM) -> PLXS_BRITIMP_EFFECTATM
# ----------------------------------------------------------------------
