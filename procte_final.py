...
def ruta_consolidado_fecha(fecha: str) -> str:
    """
    En producción, usamos CONSOLIDADO/FECHA (YYYY-MM-DD).
    """
...
if __name__ == "__main__":
    # En producción normalmente lo llamará Airflow importando run(), pero acá
    # para pruebas manuales simplemente usamos la fecha de hoy.
    run()
